...
# learning 0.00005
CUDA_VISIBLE_DEVICES=0,1 python3 /root/DL-project/1.py --lr 0.00005 --name CNN_0.00005

# learning 0.00001
CUDA_VISIBLE_DEVICES=0,1 python3 /root/DL-project/1.py --lr 0.00001 --name CNN_0.00001

# learning 0.000005
CUDA_VISIBLE_DEVICES=0,1 python3 /root/DL-project/1.py --lr 0.000005 --name CNN_0.000005

# learning 0.000001
CUDA_VISIBLE_DEVICES=0,1 python3 /root/DL-project/1.py --lr 0.000001 --name CNN_0.000001
